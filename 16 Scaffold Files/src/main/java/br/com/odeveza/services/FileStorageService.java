...
import br.com.odeveza.exception.FileStorageException;
...
public class FileStorageService {
	...
	public FileStorageService(FileStorageConfig fileStorageConfig) {
		...
		try {
			...
			throw new FileStorageException("Could not create the directory where the uplouded files will be stored", e);
		}
	}
